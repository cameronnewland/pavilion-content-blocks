...
if (!function_exists('prostart_customizer_get_css')) {

	function prostart_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = prostart_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('prostart_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(prostart_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = prostart_get_scheme_colors($scheme);
...
.sc_button.sc_button_iconic:not(.sc_button_with_icon):hover {
...
.sc_button_iconic:hover .sc_button_icon {
...
.woocommerce input.button.alt {
    ...
    -webkit-box-shadow: 6px 6px 38px {$colors['extra_hover3_02']};
    -ms-box-shadow: 6px 6px 38px {$colors['extra_hover3_02']};
    box-shadow: 6px 6px 38px {$colors['extra_hover3_02']};
}
.socials_share:not(.socials_type_drop) .social_icon {
...
.sc_button.color_style_link2:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image) {
	background-color: {$colors['text_link2_blend']};
}
...
.woocommerce input[type="submit"]:hover, .woocommerce-page input[type="submit"]:hover {
    ...
    -webkit-box-shadow: 6px 6px 38px {$colors['extra_hover3_015']};
    -ms-box-shadow: 6px 6px 38px {$colors['extra_hover3_015']};
    box-shadow: 6px 6px 38px {$colors['extra_hover3_015']};
}
...
.sc_layouts_row_type_compact .sc_button_bordered:not(.sc_button_bg_image):hover {
    background-color: {$colors['text_dark']} !important;
...
.prostart_tabs .prostart_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_hover2']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.prostart_tabs .prostart_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['alter_hover2']};
}
...
.sheme_self.sidebar .prostart_tabs .prostart_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .prostart_tabs .prostart_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .prostart_tabs .prostart_tabs_titles li.ui-state-active a {
...
.post_layout_excerpt .common_block .post_meta_components .post_categories a,
.post_layout_excerpt .post_info_top .post_categories a {
    background: {$colors['text_link']};
	color: {$colors['inverse_link']};
}
.post_layout_excerpt .common_block .post_meta_components .post_categories a:hover,
.post_layout_excerpt .post_info_top .post_categories a:hover {
    background: {$colors['text_link_blend']};
	color: {$colors['inverse_link']};
}
...
.post_item_single .post_info_top .post_categories a:hover  {
    background: {$colors['text_link_blend']};
	color: {$colors['inverse_link']};
}
...
.scheme_self.author_info a:after {
	color: {$colors['text_link']};
}
...
.wpb_single_image.rounded_shadow {
    -webkit-box-shadow: 0 0 41px {$colors['alter_hover3_006']};;
	-moz-box-shadow: 0 0 41px {$colors['alter_hover3_006']};;
	box-shadow: 0 0 41px {$colors['alter_hover3_006']};;
}
...
CSS;
					...
					$rez = apply_filters('prostart_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'prostart_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>