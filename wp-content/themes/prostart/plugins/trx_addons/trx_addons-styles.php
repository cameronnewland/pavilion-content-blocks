...
if (!function_exists('prostart_trx_addons_get_css')) {
	add_filter('prostart_filter_get_css', 'prostart_trx_addons_get_css', 10, 4);
	function prostart_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.widget_slider .slider_wrap.slider_engine_swiper .slider_outer_controls_bottom .slider_controls_wrap > a:hover {
    color: {$colors['text_link2']};
    background-color: transparent;
    border-color: transparent;
}
...
.widget_contacts .contacts_wrap .contacts_info .phone_block .phone_label, 
.widget_contacts .contacts_wrap .contacts_info .email_block .email_label, 
.widget_contacts .contacts_wrap .contacts_info .address_block .address_label {
    color: {$colors['text_dark']};
}
...
.sc_action_default .sc_action_item_link:hover {
...
.sc_blogger_item {
    ...
    -webkit-box-shadow: 0 3px 27px {$colors['alter_hover3_006']};
	-moz-box-shadow: 0 3px 27px {$colors['alter_hover3_006']};
	box-shadow: 0 3px 27px {$colors['alter_hover3_006']};
}
...
.sc_price_item {
	...
	background-color: {$colors['inverse_hover']};
	border-color: {$colors['inverse_hover']};
    -webkit-box-shadow: 0 0 27px {$colors['alter_hover3_004']};
	-moz-box-shadow: 0 0 27px {$colors['alter_hover3_004']};
	box-shadow: 0 0 27px {$colors['alter_hover3_004']};
}
.sc_price_item:hover {
    -webkit-box-shadow: 0 0 27px {$colors['alter_hover3_006']};
	-moz-box-shadow: 0 0 27px {$colors['alter_hover3_006']};
	box-shadow: 0 0 27px {$colors['alter_hover3_006']};
}
...
.sc_services_extra .sc_services_item:hover {
    -webkit-box-shadow: 0 0 27px {$colors['alter_hover3_008']};
	-moz-box-shadow: 0 0 27px {$colors['alter_hover3_008']};
	box-shadow: 0 0 27px {$colors['alter_hover3_008']};
}
...
.sc_services_extra .sc_services_item_button.sc_item_button a:hover:before,
.sc_services_extra .sc_services_item_button.sc_item_button a:hover {
    color: {$colors['text_link2']};
}
...
.sc_services_light .sc_services_item_subtitle a:hover {
    color: {$colors['text_hover']};
}
...
.scheme_self.footer_wrap .widget_contacts .socials_wrap .social_item .social_icon.social_icon_facebook:hover,
.scheme_self.footer_wrap .widget_contacts .socials_wrap .social_item .social_icon.social_icon_twitter:hover,
.scheme_self.footer_wrap .widget_contacts .socials_wrap .social_item .social_icon.social_icon_dribbble:hover,
.scheme_self.footer_wrap .widget_contacts .socials_wrap .social_item .social_icon.social_icon_behance:hover {
    color: {$colors['inverse_hover']} !important;
	background-color: {$colors['alter_hover']} !important;
}
...
.sc_testimonials .sc_testimonials_slider.slider_outer_controls_top .slider_controls_wrap > a:hover,
.sc_testimonials .sc_testimonials_slider.slider_outer_controls_bottom .slider_controls_wrap > a:hover,
.sc_testimonials .sc_testimonials_slider .slider_container.slider_controls_side .slider_controls_wrap > .slider_next:hover,
.sc_testimonials .sc_testimonials_slider .slider_outer_controls_side .slider_controls_wrap > .slider_next:hover,
.sc_testimonials .sc_testimonials_slider .slider_container.slider_controls_side .slider_controls_wrap > .slider_prev:hover,
.sc_testimonials .sc_testimonials_slider .slider_outer_controls_side .slider_controls_wrap > .slider_prev:hover {
    color: {$colors['alter_hover2']};
    background-color: transparent;
}
...
.sc_title_decoration .sc_item_title:after {
    background: linear-gradient(to left, {$colors['text_hover2']}, {$colors['text_link2']}) no-repeat;
}
.sc_title_decoration.color_style_link2 .sc_item_title:after{
    background: linear-gradient(to left, {$colors['text_link2']}, {$colors['text_hover2']}) no-repeat;
}
.sc_title_extra .sc_item_title  i {
	color: {$colors['extra_link3']};
}
.sc_title_extra .sc_item_descr,
.scheme_self.sc_title_extra .sc_item_descr {
    color: {$colors['text_light']};
}
.sc_title_extra .sc_item_subtitle,
.scheme_self.sc_title_extra .sc_item_subtitle {
    color: {$colors['text_light']};
}
